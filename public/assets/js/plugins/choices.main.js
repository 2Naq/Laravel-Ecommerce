                ...
                var s = r(i(996)),
                    ...
                    E = (function () {
                        function e(t, i) {
                            ...
                            var r = this;
                            if (void 0 === i.allowHTML) {
                                console.warn(
                                    'Deprecation warning: allowHTML will default to false in a future release. To render HTML in Choices, you will need to set it to true. Setting allowHTML will suppress this message.'
                                );
                            }
                            if (!i.hasOwnProperty('allowHTML')) {
                                i.allowHTML = true;
                            }
            ...
            686: function (e, t) {
                ...
                var i = {
                    ...
                    input: function (e, t) {
                        ...
                        // var divContainerSpan = document.createElement('div');
                        // divContainerSpan.classList.add('divInputSearch', 'div-icon-search');
                        // // Tạo phần tử span container
                        // var spanContainer = document.createElement('span');
                        // spanContainer.classList.add('choice-icon', 'span-icon');
                        // //Gắn span vào div vào
                        // divContainerSpan.appendChild(spanContainer);
                        ...
                        //Gắn input vào div
                        // divContainerSpan.appendChild(s);
                        // Tạo phần tử container và gắn các phần tử vào nơi chứa (container)
                        // var container = document.createElement('div');
                        // container.appendChild(divContainerSpan);
                ...
                function d(e) {
                    ...
                    if (r(e) || n(e)) (s = e), (t = p(e)), (i = f(e));
                        ...
                        if (((s = n), h.call(e, 'weight') && ((o = e.weight), o <= 0)))
                            throw new Error(
                                ((e) =>
                                    `Property 'weight' in key '${e}' must be a positive integer`)(n)
                            );
