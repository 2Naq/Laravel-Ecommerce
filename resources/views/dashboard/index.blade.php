...
<html>
    ...
    <body>
            ...
            >
                <div class="sidebar-collapse">
                    ...
                    >
                            ...
                            <div class="dropdown profile-element"> <span>
                                ...
                                >
                                    <span class="clear"> <span class="m-t-xs block"> <strong class="font-bold">David
                                                Williams</strong>
                                        </span> <span class="text-muted block text-xs">Art Director <b
                        ...
                        <li>
                            <a href="widgets.html"><i class="fa fa-flask"></i> <span
                                    class="nav-label">Widgets</span></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-flask"></i> <span class="nav-label">UI
                        ...
                        <li class="landing_link">
                            <a
                                target="_blank"
                                href="landing.html"
                            ><i class="fa fa-star"></i> <span class="nav-label">Landing Page</span> <span
                ...
                <div class="row border-bottom">
                    ...
                    >
                        ...
                        <ul class="nav navbar-top-links navbar-right">
                            <li>
                                <span class="m-r-sm text-muted welcome-message">Welcome to INSPINIA+ Admin
                                    Theme.</span>
                            </li>
                            <li class="dropdown">
                                <a
                        ...
                        <div class="col-lg-3">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div class="stat-percent text-success font-bold">98% <i class="fa fa-bolt"></i>
                                    </div>
                        ...
                        <div class="col-lg-3">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div class="stat-percent text-info font-bold">20% <i class="fa fa-level-up"></i>
                                    </div>
                        ...
                        <div class="col-lg-3">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div class="stat-percent text-navy font-bold">44% <i class="fa fa-level-up"></i>
                                    </div>
                        ...
                        <div class="col-lg-3">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div class="stat-percent text-danger font-bold">38% <i
                                ...
                                <div class="ibox-title">
                                    ...
                                    <div class="pull-right">
                                        <div class="btn-group">
                                            <button
                                                type="button"
                                                class="btn btn-xs btn-white active"
                                            >Today</button>
                                            <button
                                                type="button"
                                            ...
                                            <ul class="stat-list">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="stat-percent">60% <i
                                                            class="fa fa-level-down text-navy"
                                                        ></i></div>
                                                    <div class="progress progress-mini">
                                                        <div
                                                            style="width: 60%;"
        ...
        <!-- Flot -->
        <script src="access/js/plugins/flot/jquery.flot.js"></script>
        <script src="access/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
        <script src="access/js/plugins/flot/jquery.flot.spline.js"></script>
        <script src="access/js/plugins/flot/jquery.flot.resize.js"></script>
        <script src="access/js/plugins/flot/jquery.flot.pie.js"></script>
        <script src="access/js/plugins/flot/jquery.flot.symbol.js"></script>
        <script src="access/js/plugins/flot/jquery.flot.time.js"></script>

        <!-- Peity -->
        <script src="access/js/plugins/peity/jquery.peity.min.js"></script>
        <script src="access/js/demo/peity-demo.js"></script>

        <!-- Custom and plugin javascript -->
        <script src="access/js/inspinia.js"></script>
        <script src="access/js/plugins/pace/pace.min.js"></script>

        <!-- jQuery UI -->
        <script src="access/js/plugins/jquery-ui/jquery-ui.min.js"></script>

        <!-- Jvectormap -->
        <script src="access/js/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
        <script src="access/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

        <!-- EayPIE -->
        <script src="access/js/plugins/easypiechart/jquery.easypiechart.js"></script>

        <!-- Sparkline -->
        <script src="access/js/plugins/sparkline/jquery.sparkline.min.js"></script>

        <!-- Sparkline demo data  -->
        <script src="access/js/demo/sparkline-demo.js"></script>
