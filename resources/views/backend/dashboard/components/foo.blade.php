            ...
            <div class="mt-0 w-full max-w-full shrink-0 px-3 lg:w-1/2 lg:flex-none">
                <ul class="mb-0 flex list-none flex-wrap justify-center pl-0 lg:justify-end">
                    <li class="nav-item">
                        <a
                            href="https://www.creative-tim.com"
                            class="ease-soft-in-out block px-4 pb-1 pt-0 text-sm font-normal text-slate-500 transition-colors"
                            target="_blank"
                        >Creative Tim</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a
                            ...
                            class="ease-soft-in-out block px-4 pb-1 pr-0 pt-0 text-sm font-normal text-slate-500 transition-colors"
                            target="_blank"
                        >License</a>
                    </li>
                </ul>
